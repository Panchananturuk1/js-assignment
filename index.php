...
<body class="bg" style="margin-left: 0px; margin-right: 0px; margin-top: 0px">
	 ...
	 <form action="login2.php" method="post" enctype="multipart/form-data">
		...
		<tr>
			<td> <input type="text" id="Emailid" name="First_Name" placeholder="First Name" style="font-size:large" /> </td> 
		</tr>
		
		<tr>
			<td>
			 <input type="text" id="Emailid" name="Last_Name" placeholder="Last Name" style="font-size:large" /> </td>
		</tr>
